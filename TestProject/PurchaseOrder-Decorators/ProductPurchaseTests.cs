...
namespace TestProject.PurchaseOrder_Decorators
{
    ...
    public class ProductPurchaseTests
    {
        ...
        public void CompletePurchaseSuccessfully_WhenNewClient()
        {
            ...
            billingAddress2.TypeText("L�tzowplatz 17");
        ...
        {        
            ...
            var orderName = _driver.FindElement(By.CssSelector("mark[class='order-number']"));
            //string expectedMessage = $"Order #{_purchaseOrderNumber}";
            string expectedMessage = _purchaseOrderNumber;
